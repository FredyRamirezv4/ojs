<?php
/* Smarty version 4.1.0, created on 2023-03-31 15:07:04
  from 'app:controllerswizardfileUplo' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_6426daf82016f8_28526060',
...
function content_6426daf82016f8_28526060 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('for'=>"name",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['LARGE'],'title'=>"submission.form.name",'required'=>true));
$_block_repeat=true;
echo $_block_plugin2->smartyFBVFormSection(array('for'=>"name",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['LARGE'],'title'=>"submission.form.name",'required'=>true), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
...
echo $_block_plugin2->smartyFBVFormSection(array('for'=>"name",'size'=>$_smarty_tpl->tpl_vars['fbvStyles']->value['size']['LARGE'],'title'=>"submission.form.name",'required'=>true), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
